const projects = [
  {
    ...
    tags: [],
    images: ['/projects/plant-bot/CutePlant.png'],
    galleryTint: '#f2f5f0',
    gallery: [
      { src: '/projects/plant-bot/RobotCad.png',     type: 'image', transparent: true  },
      { src: '/projects/plant-bot/ExplodedView.png',  type: 'image', transparent: true  },
      { src: '/projects/plant-bot/Used.png',          type: 'image', transparent: false },
      { src: '/projects/plant-bot/Misbehaved.png',    type: 'image', transparent: false },
      { src: '/projects/plant-bot/Walking.mp4',       type: 'video', transparent: false },
      { src: '/projects/plant-bot/Autonomy.mp4',      type: 'video', transparent: false },
    ],
  ...
  },
  {
    ...
    tags: [],
    images: ['/projects/gauntlet/GloveHands.png'],
    galleryTint: '#edeef3',
    gallery: [
      { src:  '/projects/gauntlet/FusionGauntlet.png', type: 'image',  transparent: false },
      { src:  '/projects/gauntlet/Gauntlet.png',        type: 'image',  transparent: false },
      { src:  '/projects/gauntlet/HandTesting.png',     type: 'image',  transparent: false },
      { src:  '/projects/gauntlet/HappyTesting.jpg',    type: 'image',  transparent: false },
      { src:  '/projects/gauntlet/WithHandModel.png',   type: 'image',  transparent: false },
      { srcs: ['/projects/gauntlet/Open.png', '/projects/gauntlet/Closed.png'], type: 'toggle', transparent: false },
    ],
  ...
  },
  {
    ...
    tags: [],
    images: ['/projects/Drone/Drone2.png'],
    imageZoom: 1.3,
    galleryTint: '#f0f1f3',
    galleryLayout: 'grid-2x2',
    gallery: [
      { src: '/projects/Drone/Drone1.png',  type: 'image', transparent: true, zoom: true },
      { src: '/projects/Drone/Image1.png',  type: 'image', transparent: false },
      { src: '/projects/Drone/Image2.png',  type: 'image', transparent: false },
      { src: '/projects/Drone/Actual.png',  type: 'image', transparent: false },
    ],
    flip: false,
  },
  {
    ...
    images: ['/projects/modular-hydroponics/Hydroponics.png'],
    galleryTint: '#f0f5f1',
    galleryLayout: 'featured-bottom',
    gallery: [
      { src: '/projects/modular-hydroponics/Image1.jpg', type: 'image', transparent: false },
      { src: '/projects/modular-hydroponics/Image2.png', type: 'image', transparent: false },
      { src: '/projects/modular-hydroponics/Image3.png', type: 'image', transparent: false },
      { src: '/projects/modular-hydroponics/Image4.png', type: 'image', transparent: false },
    ],
    flip: false,   // [image | text | gallery]
  },
  {
    ...
    tags: [],
    images: ['/projects/autonomous-rover/Rover.png'],
    imageLarge: true,
    galleryTint: '#f0f2f5',
    galleryLayout: 'grid-2x2',
    gallery: [
      { src: '/projects/autonomous-rover/Image1.png', type: 'image', transparent: false },
      { src: '/projects/autonomous-rover/Image2.png', type: 'image', transparent: false },
      { src: '/projects/autonomous-rover/Image3.png', type: 'image', transparent: false },
      { src: '/projects/autonomous-rover/Image4.png', type: 'image', transparent: false },
    ],
    flip: true,    // [gallery | text | image]
  },
]
